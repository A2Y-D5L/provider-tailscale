...
PROJECT_NAME ?= provider-tailscale
PROJECT_REPO ?= github.com/supahlab/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= tailscale/tailscale
export TERRAFORM_PROVIDER_REPO ?= https://github.com/tailscale/terraform-provider-tailscale
export TERRAFORM_PROVIDER_VERSION ?= 0.21.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-tailscale
...
xpkg.build.provider-tailscale: do.build.images
